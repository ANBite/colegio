...
export default function ContactoEmergenciaEstudianteForm() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.post("/api/contacto-de-emergencia-estudiante", contacto);
    ...
    return (
        ...
        >
            <h2 className="text-xl font-bold mb-4">Registro de Contacto de Emergencia Estudiante</h2>

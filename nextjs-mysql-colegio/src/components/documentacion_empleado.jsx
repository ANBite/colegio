...
export default function DocumentacionEmpleadoForm() {
    ...
    useEffect(() => {
        ...
        const fetchTiposDeDocumento = async () => {
            try {
                const res = await axios.get("/api/tipo-de-documento-empleado");
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.post("/api/documentacion-empleado", documentacion);
    ...
    return (
        ...
        >
            <h2 className="text-xl font-bold mb-4">Registro de Documentación de Empleado</h2>

...
export default function TipoDocumentoEmpleadoForm() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.post("/api/tipo-de-documento-empleado", documento);
            alert("Tipo de documento para empleado registrado exitosamente");
            form.current.reset();
            setDocumento({
                nombre: "",
                descripcion: "",
    ...
    return (
        ...
        >
            <h2 className="text-xl font-bold mb-4">Registro de Tipo de Documento Empleado</h2>
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="mb-4">
                    ...
                    <input
                        ...
                        placeholder="Ej. DPI, Constancia laboral"
                    />
                </div>
